(function () {
    ...
    api("/api/admin/auth/me").then(function (me) {
        ...
        if (nav && sep) {
            [["/admin/member-admin.html", "회원 관리"], ["/admin/notice-admin.html", "공지사항"], ["/admin/inquiry-admin.html", "1:1 문의"], ["/admin/audit-log.html", "감사 로그"], ["/admin/api-usage.html", "API 사용"]].forEach(function (item) {
